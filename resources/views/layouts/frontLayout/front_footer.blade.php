				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>23/6, Block-L, besides Baytun-nur Jaam-e Masjeed, Banani-2</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank" href="https://github.com/suruzz123?tab=repositories">Md.Suruzzaman</a></span></p>
				</div>
			</div>
		</div>
